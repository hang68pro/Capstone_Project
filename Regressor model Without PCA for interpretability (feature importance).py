...
# TRAIN XGBOOST WITH FIXED BEST PARAMS
print("Training XGBoost model with known best parameters...")
...
xgb_best = xgb.XGBRegressor(**best_params, random_state=42, tree_method='hist')
...
print("\nXGBoost Performance Metrics (No PCA):")
...
plt.xticks(range(20), np.array(X.columns)[sorted_idx], rotation=90)
plt.xlabel("Feature Importance")
plt.title("Top 20 Features in XGBoost Model (No PCA)")
plt.tight_layout()
plt.show()
